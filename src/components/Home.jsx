            ...
            <div className="home-scrn-content-inner">
              <div className="home-scrn-content">
                ...
                <p>
                  ...
                  passengers to and from Earth orbit, and beyond. It is the only
                  spacecraft currently flying that is capable of returning
                  significant amounts of cargo to Earth.
                </p>
              </div>
            </div>
          </div>
